...
class InputOption
{
    ...
    /**
     * Returns the value-acceptance mode of the option.
     *
     * @return int One of self::VALUE_NONE, self::VALUE_REQUIRED or self::VALUE_OPTIONAL
     */
    ...
    {
        trigger_deprecation('symfony/console', '8.2', 'Calling "%s::isValueRequired()" is deprecated, use "%s::valueMode()" instead.', self::class, self::class);
    ...
    public function equals(self $option): bool
    {
        return $option->getName() === $this->getName()
            ...
            && ($option->valueMode() & self::VALUE_REQUIRED) === ($this->valueMode() & self::VALUE_REQUIRED)
