...
class InputOption
{
    ...
    {
        trigger_deprecation('symfony/console', '8.2', 'The "%s::isValueRequired()" method is deprecated, use "%s::valueMode()" instead.', __CLASS__, __CLASS__);
